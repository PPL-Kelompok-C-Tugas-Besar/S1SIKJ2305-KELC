...
// Description : Widget test untuk fitur ubah password
...
void main() {
  ...
  group('TS.AUTH-4.001 - Ubah Password', () {
    ...
    // Password lama salah — validasi client lulus, error dikembalikan server
    testWidgets('TC.AUTH-4.001.005 - Semua field valid, validasi client lulus tanpa error', (tester) async {
      await tester.pumpWidget(buildApp());
      await tester.pumpAndSettle();
