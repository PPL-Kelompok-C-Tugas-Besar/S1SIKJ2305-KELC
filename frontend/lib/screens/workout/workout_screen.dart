...
// State untuk mengatur alur latihan
...
class _AlifWorkoutScreenState extends State<AlifWorkoutScreen> {
  ...
  // Controller untuk durasi dan repetisi
  ...
  // List data olahraga sesuai aset GIF yang lo punya
  ...
  // Fungsi untuk balik ke menu input durasi/reps
  ...
  Widget build(BuildContext context) {
    // Tombol back muncul di kondisi tertentu
  ...
  // UI Eksekusi Latihan
  Widget _exerciseUI() {
    final totalDuration = int.tryParse(_workDurationController.text) ?? 30;
    final progress = _timerSeconds / totalDuration;
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 20),
        // Circular Progress Indicator dengan teks angka besar
        SizedBox(
          height: 200,
          width: 200,
          child: Stack(
  ...
  // UI Waktu Istirahat
  Widget _restUI() {
    final totalRest = int.tryParse(_restDurationController.text) ?? 20;
    final progress = _timerSeconds / totalRest;
